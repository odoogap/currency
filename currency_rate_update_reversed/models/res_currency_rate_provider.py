...
class ResCurrencyRateProvider(models.Model):
    ...
    def convert_rates_to_company_currency(self, rates, base_currency, get_euro_currency=False):
        currency_rates = {}
        # for each rate convert the currency for the base_currency
